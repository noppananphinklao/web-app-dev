...
app.post("/submit", (req, res) => {
  ...
  let adj_random_index = Math.floor(Math.random() * adj.length) ; 
  let noun_random_index = Math.floor(Math.random() * noun.length) ; 
  
  res.render('index.ejs', ({adj:adj[adj_random_index], noun:noun[noun_random_index]}))
